				   ...
				   if(mysqli_num_rows($res))
				   {
					   while($row=(mysqli_fetch_array($res)))
					   {
						   ...
						   echo "<li class='dropdown'>";
						    echo "<a class='dropdown-toggle' data-toggle='dropdown' href='#'style='align:center;display:inline;'>";
						   echo '<img class="img-circle imge" src="data:image/jpg;base64,'.base64_encode( $row['img1'] ).' "  width="50" height="50" />';
						   echo "</a>";
						    echo "<ul class='dropdown-menu'>";
						   echo "<li>";
						   echo "<a href='logout.php' style='display:inline;'>"."Logout"."</a></li>";
						   echo "</ul>";
						   echo "</li>";
